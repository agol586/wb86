...
final class ReleaseContractTests: XCTestCase {
    ...
    func testBundleHasRequiredInputMethodMetadata() throws {
        ...
        XCTAssertEqual(info["CFBundleShortVersionString"] as? String, "1.5.4")
    ...
    func testOfficialWebsiteCoversTheCompleteDecisionAndInstallJourney() throws {
        ...
        XCTAssertTrue(html.contains("v1.5.4"))
        XCTAssertTrue(html.contains("releases/tag/v1.5.4"),
                      "published v1.5.4 website must link to the immutable release")
