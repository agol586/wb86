...
final class ReleaseContractTests: XCTestCase {
    ...
    func testBundleHasRequiredInputMethodMetadata() throws {
        ...
        XCTAssertEqual(info["CFBundleShortVersionString"] as? String, "1.5.3")
        XCTAssertEqual(info["CFBundleVersion"] as? String, "15")
    ...
    func testOfficialWebsiteCoversTheCompleteDecisionAndInstallJourney() throws {
        ...
        XCTAssertTrue(html.contains("v1.5.3"))
        XCTAssertTrue(html.contains("releases/tag/v1.5.3"),
                      "published v1.5.3 website must link to the immutable release")
