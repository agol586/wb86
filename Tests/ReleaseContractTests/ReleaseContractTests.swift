...
final class ReleaseContractTests: XCTestCase {
    ...
    func testBundleHasRequiredInputMethodMetadata() throws {
        ...
        XCTAssertEqual(info["CFBundleShortVersionString"] as? String, "1.5.2")
        XCTAssertEqual(info["CFBundleVersion"] as? String, "14")
    ...
    func testOfficialWebsiteCoversTheCompleteDecisionAndInstallJourney() throws {
        ...
        XCTAssertTrue(html.contains("v1.5.2"))
        XCTAssertTrue(html.contains("releases/tag/v1.5.2"),
                      "published v1.5.2 website must link to the immutable release")
