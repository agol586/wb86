...
2. In each of the seven application classes, start composition and navigate multiple candidate pages.
...
2. Traverse Input, Keys, Candidates, Learning, User Lexicon and Privacy in their visible order.
3. Change every non-destructive setting, apply it, trigger one invalid value, and confirm the error is
   announced. Restore defaults and confirm focus remains predictable.
