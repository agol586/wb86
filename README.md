...
<p align="center">
  <a href="https://github.com/agol586/wb86/releases/tag/v1.5.4"><img src="https://img.shields.io/badge/release-v1.5.4-164f49?style=flat-square" alt="v1.5.4 release"></a>
...
<p align="center">
  ...
  ·
  <a href="https://github.com/agol586/wb86/releases/tag/v1.5.4"><strong>获取 v1.5.4</strong></a>
  ·
...
需要 Apple Silicon Mac、macOS 13 或更高版本以及 Xcode。v1.5.4 以源码 Release 发布；正式 Developer
